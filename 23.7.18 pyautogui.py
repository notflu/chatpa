# -*- coding: utf-8 -*-
"""
Created on Tue Jul 18 17:03:50 2023
...
pyautogui.moveTo(41,261)
pyautogui.click()
for i in range (0,20):
    
    pyautogui.moveTo(657, 855)
    pyautogui.click()
    time.sleep( 0.5 )
    pyautogui.moveTo(933,67)
    pyautogui.click()
    pyautogui.hotkey('ctrl', 'c')
    pyautogui.moveTo(38,431)
    pyautogui.click()
    pyautogui.hotkey('ctrl', 'v')
    pyautogui.hotkey('enter')
    pyautogui.moveTo(1808, 302)
    pyautogui.click()
    
    
    
    pyautogui.moveTo(1413, 855)
    pyautogui.click()
    time.sleep( 0.5 )
    pyautogui.moveTo(933,67)
    pyautogui.click()
